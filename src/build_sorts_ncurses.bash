...
while read i; do
	...
	"$gcc_cmd" -Wall -O2 -DVERSION=\"1.0.0\" -DBUILD=\"202207092333\" -DIS_SNAPSHOT=1 terminal_visualiser.c helper/precise_and_acc_time.c helper/beep_log.c helper/ioext.c "$i.c" -o "../$i" -lm -lcurses;
done < "build_list.txt";
mkdir -p ../sounds;
