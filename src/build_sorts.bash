...
while read i; do
	...
	"$gcc_cmd" -Wall -O2 -DNO_NCURSES -DVERSION=\"1.2\" -DBUILD=\"202207220316\" -DIS_SNAPSHOT=1 terminal_visualiser.c helper/precise_and_acc_time.c helper/beep_log.c helper/anti_quicksort.c helper/ioext.c helper/triangular_input.c helper/smooth_heapify.c "$i.c" -o "../$i" -lm;
done < "build_list.txt";
mkdir -p ../sounds;
